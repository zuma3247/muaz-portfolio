...
const cards = [
  {
    ...
    label: "Leadership",
    copy: "Guiding teams and building communities through empathy and action.",
    icon: Users,
    color: "#E3B53D",
  },
  {
...
export function NexusHub({
  ...
  return (
    <main className="relative w-full min-h-screen bg-[#0a0e1a]">
      <div className="mx-auto max-w-6xl px-6 pt-24 pb-12 md:py-20">
        {/* Nav buttons — desktop only */}
        <nav className="hidden md:flex justify-end gap-3 mb-16" aria-label="Main navigation">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          >
            {/* Profile image */}
            <div className="w-32 h-32 md:w-56 md:h-56 rounded-2xl overflow-hidden border border-white/10">
              <img
                src={profileImage}
                alt="Muaz"
            ...
            {cards.map((card, i) => {
              ...
              return (
                <motion.button
                  ...
                  className="group flex items-center gap-5 p-5 rounded-xl glass border border-white/10 text-left hover:border-opacity-40 transition-all w-full"
                  style={{
